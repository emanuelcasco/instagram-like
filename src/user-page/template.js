      ...
      <div class="col s12 m10 offset-m1 l8 offset-l2 center-align heading">
        <div class="row">
          <div class="col s12 m10 offset-m1 l3 offset-l3 center-align">
            <img src="${user.avatar}" alt="User profile photo" class="circle responsive-img avatar">
          </div>
            ...
            return yo `
              <div class="col s12 m6 l4">
                <a href="/${user.username}/${picture.id}" class="picture-container">
                  <img src="${picture.src}" class="picture" height="300px" width="300px">
                  <div class="likes">
                ...
                <div id="modal${picture.id}" class="modal">
                  ...
                  <div class="modal-footer">
                    <div class="btn btn-flat modal-close">
